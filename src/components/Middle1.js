...
function Middle1() {
  return (
    <Container className="middle1" >
            <img href='#bolsos' src={middle1} id="middle1" className="rounded float-left" alt="Responsive" />
            <h3 id="img1">Marca X | Materiales de escuela</h3>
            <img src={middle2} id="middle2" className="rounded float-right" alt="Responsive"/>
